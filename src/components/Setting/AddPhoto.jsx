        ...
        <div className="rounded-sm border border-stroke bg-white shadow-default ">
            ...
            <div className="p-7">
                <form action="#">
                    ...
                    <div id="FileUpload" className="relative mb-5 block w-full cursor-pointer appearance-none rounded border border-dashed border-primary bg-gray-100 px-4 py-4 dark:bg-meta-4 md:py-7">
                    ...
                    <div className="flex justify-end gap-4">
                        <button className="flex justify-center rounded border border-stroke px-6 py-2 font-medium text-black hover:shadow-sm" type="submit">
                            Cancel
                        </button>
                        <button className="flex justify-center rounded bg-primary px-6 py-2 font-medium text-gray-100 hover:bg-opacity-90" type="submit">
                            Save
                        </button>
                    </div>
                </form>
